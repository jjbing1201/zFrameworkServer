...
void IOS_MAIN::change_process(bool check, bool operation, \
...
std::map<std::string, std::string> IOS_MAIN::into_process(\
                        ...
                        std::map<std::string, std::string> data)
{
    ...
    // 2.1 check part.
    IOSCHECK worldcheck;
    IOSOPERATION worldoperation;    
    IOSRETURN worldreturn;
    IOSFORMAT worldformat;
