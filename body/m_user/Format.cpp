...
std::map<std::string, std::string> IOSFORMAT::normal_format_inside(std::string interfaceName, std::map<std::string, std::string> data)
{
...
std::map<std::string, std::string> IOSFORMAT::format_inter(\
...
std::map<std::string, std::string> IOSFORMAT::format_inter_inherit(\
                                   std::string interface, \
                                   std::map<std::string, std::string> data)
{
    /* Statement about return => result. */
