...
void SHOP_MAIN::change_process(bool check, bool operation, \
...
std::map<std::string, std::string> SHOP_MAIN::into_process(\
                        ...
                        std::map<std::string, std::string> data)
{
    ...
    // 2.1 check part.
    SHOPCHECK worldcheck;
    SHOPOPERATION worldoperation;    
    SHOPRETURN worldreturn;
    SHOPFORMAT worldformat;
